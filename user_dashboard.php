...
if (isset($_SESSION['userid'])) { ?>
                        ...
                        <div class="event">
                            <div class="img-container">
                                <?php if ($ce['image_type'] == 1) {
                                    ...
                                    echo '<iframe width="100%" height="400px" src="https://www.youtube.com/embed/' . $ce['image'] . '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                                } elseif ($ce['image_type'] == 3) {
                                    echo '<iframe src="https://player.vimeo.com/video/' . $ce['image'] . '" width="100%" height="400px" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>';
                                }
                                ?>
                            </div>
            ...
            <div class="row">
                ...
                foreach ($mybookedevents as $be) { ?>
                    <div class="col-sm-4">
                        <div class="event">
                            <div class="img-container">
                                <img src="layout/images/<?php echo  $be['image'] ?>">
                            </div>
                            <ul class="info-event list-unstyled">
    ...
    <section class="events">
        <div class="container">
            <div class="row">
                <?php
                foreach ($mypastbookedevents as $pbe) { ?>
                    <div class="col-sm-4">
                        <div class="event">
                            <div class="img-container">
                                <img src="layout/images/<?php echo  $pbe['image'] ?>">
                            </div>
                            <ul class="info-event list-unstyled">
                                <li class="text-center"> <?php echo $pbe['title'] ?></li>
                                <li class="text-center"> <?php echo $pbe['date_debut'] ?></li>
                                <li class="text-center"> <?php echo $pbe['name'] ?></li>
                                <?php echo '<a href="event_show.php?eventID=' . $pbe['id_event'] . '" class="btn btn-info text-center btn-block">Check Details</a>'; ?>
                            </ul>
                        </div>
                    </div>
                <?php } ?>
